                    ...
                    {   
                        ...
                        {   
                            ...
                            {   
                                ...
                                {   // save profile image
                                    $query = "update locations set location_image = '$filename' where location_id = '$last_id' limit 1";
                                }
...
<html>
    ...
    <body>
        ...
        <div >
            ...
            <div  style="min-height:400px;padding:0px;">
                <br>
                <br>
                <form method="post" enctype="multipart/form-data">
                    ...
                    <br>
                    <br>
                    <input id="post_button" type="submit" value="Change" style="background-color: cornflowerblue;border-color:cornflowerblue;">
                    <br>
                    </div>
                </form>
            </div>
